    ...
    >
      ...
      >
        <div class="flex items-center justify-between border-b-2 border-black pb-3">
          ...
          <button onclick={() => isEditOpen = false} class="rounded-lg border-2 border-black bg-white p-1.5 text-black shadow-secondary transition-all">
            <X class="h-5 w-5" />
          </button>
        </div>
        ...
        <form onsubmit={handleUpdateSubscription} class="space-y-4">
          ...
          <div class="flex justify-end gap-3 border-t-2 border-black pt-3">
            <button 
              type="button" 
              onclick={() => isEditOpen = false}
              class="cursor-pointer rounded-[6px] border-2 border-black bg-white px-4 py-2 text-xs font-bold text-black shadow-secondary transition-all"
            >
              Hủy
            </button>
            <button 
              type="submit"
              disabled={isSaving}
              class="flex cursor-pointer items-center gap-1 rounded-[6px] border-2 border-black bg-blue-300 px-4 py-2 text-xs font-black text-black shadow-secondary transition-all disabled:opacity-50"
            >
              {#if isSaving}
